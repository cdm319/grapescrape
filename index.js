...
const buildURL = (region, vintageFrom, vintageTo, grape = "", subregion = "") => {
    const regionContentIds = { bordeaux: '1073742856', usa: '1073742871', rioja: '1073742747', ribera: '1073742748', tuscany: '1073742741' };
    const regionCode = regionContentIds[region];

    const params = encodeURIComponent(JSON.stringify({
        "Unit": "14156,14157,147166", // bottle, half-bottle
        "VintageFrom": vintageFrom,
        "VintageTo": vintageTo,
        "Grape": grape,
        "Region": subregion,
        "ProductType": "17045", // red wine
        "PriceMinimum": 15.0,
        "Status": "0,2" // in stock, low stock
    }));

    return `https://www.thewinesociety.com/CustomFileDownload/DownloadCsv?contentId=${regionCode}&parameters=${params}`;
};
